...
/**
 * Metodo per l'invio al server del nome del Client:
 * condizione necessaria per l'inizio della chat
 */
public void hello() {
...
public void Start() {
	...
	thC= new ThreadClient (inputServer); //viene creato e fatto partire un ThreadClient 
	thC.start();
